...
class CClientStatusRoom;
USING_NS_CC; 
//USING_NS_CC_EXT;

class RoomScene : public CCLayer , public cocos2d::extension::CCTableViewDelegate,public cocos2d::extension::CCTableViewDataSource ,public CCTextFieldDelegate
{
public:
	...
	void setCmdStatus(CClientStatusRoom * pCmdStatus);
