...
//
//KeyboardNotificationLayer* KeyboardNotificationLayer::createTextInputTest(int nIndex)
//{
//	switch(nIndex)
//	{
...
//
//	KeyboardNotificationLayer* pTestLayer = KeyboardNotificationLayer::createTextInputTest(testIdx);
