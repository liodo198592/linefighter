...
import com.badlogic.androidgames.SperLineFigher.WorderRenderer.SHOWACTION;
...
//				}
	...
	Long calcARound(List<Player> players , List<List<Action>> actions, Map<Long,List<String>> description,Queue<StepActioin> stepActioins)
	{
	...
	private void insertDamagedStep(Player player,Action action,Queue<StepActioin> stepActioins){
		...
		//stepActioin.direction = action.derection.intValue();
//		if(stepActioin.name.equals("PLAYER")){
//			Log.d("qigong", stepActioin.name + ":" + stepActioin.direction);
//		}
