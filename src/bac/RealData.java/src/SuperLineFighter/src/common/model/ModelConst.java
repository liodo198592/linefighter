...
public class ModelConst {
	...
	public static Long MAX_HP = 20L;
	public static Long statusFlag; //UI和engine 之间共享，用来决定是否进行下一步工作
	public static Long MAX_PLAYER = 4L;
	public static Long MAX_ACTNUM = 3L;
	public static String g_Control1Name = "zhouyu";
	public static Long SCFlag; //1 表示 服务器  2表示客户端

	public static String selfName; //自身的名字
